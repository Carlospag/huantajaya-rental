<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.Master" CodeBehind="frm_ModificarProveedor.aspx.vb" Inherits="ITI.SHVT.INTERFAZ.frm_ModificarProveedor" %>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ReadOnly="true" Font-Size="Larger" ID="txt_RutProveedor" runat="server" class="input form-control text-center" />
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txt_RutDestinatario" MinLenght="8" MaxLength="9" AutoPostBack="true" pattern="[0-9]*" runat="server" class="input form-control" />
                ...
                <section class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="pull-right">
                            ...
                            <asp:Button runat="server" ID="btn_Guardar" CssClass="btn btn-primary" Text="ACTUALIZAR PROVEEDOR" />
                        </div>
                    </div>
                </section>
