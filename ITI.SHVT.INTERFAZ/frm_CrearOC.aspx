<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.Master" CodeBehind="frm_CrearOC.aspx.vb" Inherits="ITI.SHVT.INTERFAZ.frm_CrearOC" %>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <p class="text-center">
                                        ...
                                        OC N°: <label id="noc" style="font-size:larger" runat="server"></label>
                                    </p>
                                </div>
                                <div class="modal-footer">
