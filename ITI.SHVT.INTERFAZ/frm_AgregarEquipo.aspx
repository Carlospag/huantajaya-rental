<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.Master" CodeBehind="frm_AgregarEquipo.aspx.vb" Inherits="ITI.SHVT.INTERFAZ.frm_AgregarEquipo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:SqlDataSource ID="sds_SugerenciaAfis" runat="server" ConnectionString="<%$ ConnectionStrings:SHVTBDConnectionString %>"
        SelectCommand="up_parque_s_SugerenciaAFIS" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
            ...
            <ContentTemplate>
                <section>
                    <div runat="server" id="pnl_Agregado" visible="false" class="alert alert-success alert-dismissible" role="alert">
                        ...
                        <strong>Terminado!</strong> El Equipo se ha registrado correctamente.
                    </div>
                </section>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-4">
                            <label runat="server" id="lbl_UM">&nbsp; </label>
                        </div>
                        <div class="col-md-4">
                            <label runat="server" id="lbl_AND">&nbsp; </label>
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">FORMULARIO INGRESO EQUIPOS</div>
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label runat="server" id="lbl_Colaborador">AFI&nbsp; </label>
                                        <label style="color: red">*</label>
                                        <span runat="server" style="color: red" id="lbl_ErrorAFI"></span>
                                        <asp:TextBox MaxLength="6" ID="txt_AFI" Font-Size="X-Large" Font-Bold="true" runat="server" pattern="[0-9]*" class="input form-control" AutoPostBack="true" required="true" type="number" />
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>Largo&nbsp; </label>                                    
                                        <asp:TextBox ID="txt_LargoEquipo" runat="server" class="input form-control"  />
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label >Alto&nbsp; </label>                              
                                        <asp:TextBox ID="txt_AltoEquipo" runat="server" class="input form-control"  AutoPostBack="true" />
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label >Ancho&nbsp; </label>  
                                        <asp:TextBox ID="txt_AnchoEquipo" runat="server" class="input form-control"  AutoPostBack="true" />
                                    </div>
                                </div>
                                <div class="col-md-3">  
                                    <div class="form-group">
                                        <label >Peso&nbsp;</label>
                                        <asp:TextBox ID="txt_PesoEquipo" runat="server" class="input form-control"  AutoPostBack="true" />
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="pull-right">
                                ...
                                <asp:Button ID="btn_Guardar" runat="server" Text="Registrar Equipo" CssClass="btn btn-primary" data-toggle="modal" data-target="#exampleModalCenter" />
                            </div>
                        </div>
                    </div>
