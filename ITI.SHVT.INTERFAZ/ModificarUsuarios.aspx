<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.Master" CodeBehind="ModificarUsuarios.aspx.vb" Inherits="ITI.SHVT.INTERFAZ.ModificarUsuarios" %>
        ...
        <asp:UpdatePanel runat="server" ID="upp_Principal" ChildrenAsTriggers="true" UpdateMode="always">
            <ContentTemplate>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <asp:SqlDataSource ID="sds_Usuarios" runat="server" ConnectionString="<%$ ConnectionStrings:SHVTBDConnectionString %>" 
                                                SelectCommand="up_shvt_s_Usuarios" SelectCommandType="StoredProcedure" ></asp:SqlDataSource> <!-- Listar usuarios del sistema -->
                                            
                                            <asp:SqlDataSource ID="sds_Usuario" runat="server" ConnectionString="<%$ ConnectionStrings:SHVTBDConnectionString %>" 
                                                SelectCommand="up_shvt_s_SoloUsuario" SelectCommandType="StoredProcedure">
                                                <SelectParameters>
                                            ...
                                            <asp:SqlDataSource ID="sds_OpcionesUsuario" runat="server" ConnectionString="<%$ ConnectionStrings:SHVTBDConnectionString %>" 
                                                SelectCommand="up_shvt_s_OpcionesUsuario" SelectCommandType="StoredProcedure">
                                                <SelectParameters>
                                                    <asp:Parameter name="id_Usuario" type="Int32"></asp:Parameter>
                                                </SelectParameters>
                                            </asp:SqlDataSource>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox runat="server" ID="txt_NombreUsuario" CssClass="form-control" pattern="[A-Za-zñÑáéíóúÁÉÍÓÚ\s ]+" title="Sólo se permiten letras." ReadOnly required></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="ApellidoPaternoUsuario">Apellido paterno: </label>
                                            <asp:TextBox runat="server" ID="txt_ApellidoPaternoUsuario" CssClass="form-control" pattern="[A-Za-zñÑáéíóúÁÉÍÓÚ\s ]+" title="Sólo se permiten letras." ReadOnly required></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="ApellidoMaternoUsuario">Apellido materno: </label>
                                            <asp:TextBox runat="server" ID="txt_ApellidoMaternoUsuario" CssClass="form-control" pattern="[A-Za-zñÑáéíóúÁÉÍÓÚ\s ]+" title="Sólo se permiten letras." ReadOnly required></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <asp:SqlDataSource ID="sds_OpcionesSistema" runat="server" ConnectionString="<%$ ConnectionStrings:SHVTBDConnectionString %>" 
                    SelectCommand="up_shvt_s_OpcionesSistema" SelectCommandType="StoredProcedure" ></asp:SqlDataSource> <!-- Listar opciones del sistema -->
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <asp:ListBox runat="server" ID="lbx_OpcionesSistema" DataSourceID="sds_OpcionesSistema" DataValueField="id_OpcionSistema"
                                                DataTextField="NombreOpcionSistema" CssClass="form-control" SelectionMode="Multiple" Rows="6" required="true"></asp:ListBox>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                      <div class="form-group">
